package com.see.cloud.consumer.mis.config;
...
import com.see.cloud.common.cahe.RedisCacheManager;
import com.see.cloud.common.cahe.RedisSessionDao;
import com.see.cloud.consumer.mis.shiro.MyShiroRealm;
...
public class ShiroConfig {
	...
	@Autowired
	private RedisCacheManager edisCacheManager;
	...
	public SecurityManager securityManager(DefaultWebSessionManager webSessionManager) {
		...
		// 注入缓存管理器;
		securityManager.setCacheManager(edisCacheManager);// 这个如果执行多次，也是同样的一个对象;
	...
	public DefaultWebSessionManager configWebSessionManager() {
		...
		manager.setCacheManager(edisCacheManager);// 换成Redis的缓存管理器
