package com.see.cloud.provider.common.advice;
...
import com.see.cloud.core.common.exception.ResultException;
...
public class ExceptionHandlerAdvice {
	...
	public ResultBody handle(Exception e) {
		...
		logger.error("统一异常 end");
		return ResultUtils.warn(ResultCode.EXCEPTION);
	}
}